...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link add-border" href="settings.jsp"> Settings</a></li>
    ...
    <div class="container">
    	<div class="row">
    		<form name="form" id="form" method="post" action="SettingsViewController">
    ...
    <div class="container">
                    <div class="row row-content table-responsive">
                        <table id="displayTable" class="table table-striped table-hover" style="width:50%" cellpadding="1" cellspacing="0" border="3px">
                            ...
                            <c:forEach items="${al}" var="ub">
                                <tr align="center">
                                    ...
                                    <td>${ub.email}</td>
                                    <td>${ub.password}</td>
                                    <td><a href="edit.jsp?firstname=${ub.firstname}&lastname=${ub.lastname}&email=${ub.email}&password=${ub.password}" class="btn btn-sm btn-block btn-warning">Edit</a></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </div>
